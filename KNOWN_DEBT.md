...
## r29 note
Validation DEFER is now dependency-driven for ability lineage and historical simulation references. Time-dependent uncertainty (`TICK_AHEAD`, `RESPAWN_EARLY`) still uses bounded timers. This reduces audit/progress spam without weakening q2 or deterministic replay.
