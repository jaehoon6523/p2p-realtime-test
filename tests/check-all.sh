...
node "$ROOT/tests/audit-receipt-retry.js"
node "$ROOT/tests/multiplayer-audit-liveness.js"
node "$ROOT/tests/log-copy.js"
...
node "$ROOT/tests/bootstrap-runtime-state.js"
node "$ROOT/tests/remote-bootstrap-render.js"
...
node "$ROOT/tests/movement-continuous-no-brake.js"
