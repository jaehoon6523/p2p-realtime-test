...
node "$ROOT/tests/ability-bootstrap-lineage.js"
node "$ROOT/tests/audit-receipt-retry.js"
node "$ROOT/tests/audit-dependency-wakeup.js"
node "$ROOT/tests/simulation-ref-wakeup.js"
...
node "$ROOT/tests/runtime-state-contract.js"
node "$ROOT/tests/bootstrap-prefix-install.js"
node "$ROOT/tests/bootstrap-runtime-state.js"
node "$ROOT/tests/bootstrap-no-ack-spam.js"
