...
const context={
  console,Map,Set,Date,Math,JSON,String,Number,Object,Array,command,queueMicrotask,
  performance:{now:()=>1000},
  setInterval:()=>0,clearInterval:()=>{},setTimeout:()=>0,clearTimeout:()=>{},
  PROTOCOL:13,RULESET_REVISION:'pssf-v13-r29',AUTO_DEBUG:true,TEMPORAL_RETRY_MIN_MS:40,TEMPORAL_DEFER_MAX_MS:1600,
  ...
  confirmedAbilitySeq:new Map(),abilityAuditWaiters:new Map(),abilityAuditWaiterByCommand:new Map(),auditWakeQueued:new Set(),
